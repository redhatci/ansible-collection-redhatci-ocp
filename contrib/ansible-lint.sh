...
pushd /tmp/ansible-lint-installs/ansible_collections/redhatci/ocp
ansible-test sanity --docker --color --truncate 0 --no-redact --no-pip-check --python 3.9 -v plugins/ roles/
popd
popd
