...
classDef rescue stroke:#665352,stroke-width:2px;
  ...
  Start-->|Task| Print_list_of_XML_reports_file_names0[print list of xml reports file names<br>When: **junit2json debug**]:::task
  Print_list_of_XML_reports_file_names0-->|Task| Merge_multiple_JUnit_XML_files_into_single_consolidated_report1[merge multiple junit xml files into single<br>consolidated report]:::task
  Merge_multiple_JUnit_XML_files_into_single_consolidated_report1-->|Task| Write_merge_resulting_file2[write merge resulting file<br>When: **junit2json merged xml stdout   length   10**]:::task
