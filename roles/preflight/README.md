...
<<<<<<< HEAD
preflight_image                   | quay.io/opdev/preflight:1.6.9                                  | Optional. [Version of Preflight Cert Suite to run check operator cert suite](https://quay.io/repository/opdev/preflight?tab=tags)
=======
preflight_image                   | quay.io/opdev/preflight:1.6.11                                  | Optional. [Version of Preflight Cert Suite to run check operator cert suite](https://quay.io/repository/opdev/preflight?tab=tags)
>>>>>>> mixin/main
