# gen_node_labels outputs node labels describing the host's operating system, CPU architecture, and available container engines as a space-separated string.
