...
- An ansible inventory with at least one node in the OpenShift cluster with at least an available disk to use for local storage
...
| `sl_storage_class` | `""` | Name of the StorageClass to create |
