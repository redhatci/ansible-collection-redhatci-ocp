...
- username: string         # Required: Username to add key for
  ...
  key: string              # Optional: Public key content (if not generating)
  ...
  vars:
    ...
    fc_ssh_keys:
      ...
      - username: developer1
        ...
        key: "ssh-ed25519 AAAAB3NzaC1yc2EAAAADAQAB... developer1@workstation"
  ...
  vars:
    ...
    fc_ssh_keys:
      - username: alice
        ...
        key: "ssh-ed25519 AAAAB3NzaC1yc2E... alice@work"
      - username: bob
        title: "Bob Laptop Key"
        generate: true
        key_file: "{{ playbook_dir }}/keys/bob_id_ed25519"
```
