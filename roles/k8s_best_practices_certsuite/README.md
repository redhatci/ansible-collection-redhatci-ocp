...
kbpc_non_intrusive_only                 | false                                                                                                                                                                                                                                   | (This variable can only be used until Certsuite v5.4.8) If set to true, skip intrusive tests which may disrupt cluster operations (default `false`).
kbpc_intrusive                          | true                                                                                                                                                                                                                                    | (This variable can only be used from versions higher than v5.4.8 and when using HEAD) If set to false, skip intrusive tests which may disrupt cluster operations (default `true`).
