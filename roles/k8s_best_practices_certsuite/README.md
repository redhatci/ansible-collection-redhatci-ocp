...
This role encapsulates the logic for the [Red Hat Best Practices Test Suite for Kubernetes](https://github.com/test-network-function/cnf-certification-test). It is responsible for deploying the certsuite and running the tests.
...
kbpc_repository                         | https://github.com/test-network-function/cnf-certification-test                                                                                                                                                                         | Repository to download the certsuite code.
