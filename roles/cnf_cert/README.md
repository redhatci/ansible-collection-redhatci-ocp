...
This role encapsulates the logic for the [Red Hat Best Practices for K8s](https://github.com/redhat-best-practices-for-k8s/certsuite), formerly Test Network Function (TNF). It is responsible for deploying the TNF framework and running the tests in DCI.
...
test\_network\_function\_repo           | https://github.com/redhat-best-practices-for-k8s/certsuite                                                                                                                                                                         | Repository to download the tnf code.
...
This variable must be a dictionary, where the key is the tnf environment variable to be used during execution. You have some examples of possible variables to be provided in the [tnf docs](https://redhat-best-practices-for-k8s.github.io/certsuite/runtime-env) or in the [script](https://github.com/redhat-best-practices-for-k8s/certsuite/blob/main/script/run-container.sh) used to run the tnf container.
