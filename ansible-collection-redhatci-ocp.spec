...
%changelog
* Wed Aug  5 2026 Frederic Lepied <flepied@redhat.com> - 5.0.EPOCH-VERS
- Non-backward compatible: rename workarounds to mabi_workarounds in monitor_agent_based_installer role
